...
!27 july: core volume fraction added to output
      ...
      logical, target :: append_output_file, &
                 ...
                 normalize_s11,print_sphere_data,input_single_origin_expansion, &
      ...
      data normalize_s11,print_sphere_data,input_single_origin_expansion,azimuthal_average/.true.,.true.,.true.,.false./
      ...
      contains
         ...
         elseif(varlabel.eq.'single_origin_expansion') then
            vartype='l'
            lvarvalue=>input_single_origin_expansion
...
!               if(print_random_configuration.and.(.not.configuration_average)) then
         ...
         single_origin_expansion=input_single_origin_expansion
